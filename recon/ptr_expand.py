...
from _common import get_target, write_encrypted, _read_encrypted, http_get, crt_sh_subdomains, wayback_subdomains
...
def _wayback(domain: str) -> set[str]: return wayback_subdomains(domain, limit=1000)
